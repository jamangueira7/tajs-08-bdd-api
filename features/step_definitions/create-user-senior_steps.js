...
BeforeStep(async function() {
    _testServerAddress = await this.testServerAddress
})
    

When(`I create a new user with the following details 3:`, async function(dataTable) {
...
Then(`the user should be categorized as a {string} "3"`, async function(category) {
...
Then(`I should receive a JSON response with the user's details "3"`, async function() {
    const expectedUser = {
        "birthDay": "1950-01-01",
        "category": "senior",
...
Then(`the user's category should be {string} "3"`, function (category) {
